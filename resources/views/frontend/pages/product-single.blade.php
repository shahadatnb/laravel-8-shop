...
@endsection
@section('content')
<!-- <section class="_inner_page_banner py-4">
	<div class="container">
		<div class="_in_title_text">
			<h1 class="fs-5 text-capitalize">{{$product->title}}</h1>
		</div>
	</div>
</section> -->

<section class="_nav_product_view py-3" style="background-color: #f5f5f5;">
	<div class="container">
	<nav class="fs-5 text-capitalize" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb m-0">
    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
				@if($product->categories)
				<li class="breadcrumb-item">{{ $product->categories[0]->title }}</li>
    <li class="breadcrumb-item active" aria-current="page">{{$product->title}}</li>
				@endif
  </ol>
</nav>
	
			<!-- <nav class="fs-5 text-capitalize">			
				<ul class="list-unstyled d-flex">
					<li class="pe-2"><a href="{{url('/')}}">Home</a> > </li>
					@if($product->categories)
					<li class="pe-2"><a href="#">{{ $product->categories[0]->title }}</a> > {{$product->title}}</li>
					@endif
				</ul>
			</nav> -->
	</div>
...
<section class="_prduct_details py-3">
	<div class="container">
		<div class="row">
			<div class="col-sm-5 col-lg-7">
				...
				<div class="row">
					...
					<div class="col-10">
						<div class="picZoomer">
							<img id="featured" class="w-100" src="{{ asset('storage/' . $photos[0]->path) }}">
						</div>
					</div>
				</div>
				@endif
                ...
                <div class="slider owl-carousel owl-theme">
					...
					<div class="item" data-hash="d-{{$item->id}}"><img class="_side_1_img" width="100" src="{{ asset('storage/' . $item->path) }}">
			</div>
			@endforeach
		</div>
		...
		{{-- <div class="slider-for">
					@foreach ($product->allphotos as $item)
					<div><img class="_side_1_img" width="100" src="{{ asset('storage/' . $item->path) }}">
	</div>
	@endforeach
	</div>
	...
	<div class="row_nav_tabs">
		<ul class="nav nav-tabs d-flex justify-content-center align-items-center pb-5" id="myTab" role="tablist">
