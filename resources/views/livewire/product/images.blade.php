        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-4 col-lg-3">
                    <i class="fas fa-photo-video image-thumb" wire:click="makeThumb({{$item->id}})" title="Set thumbnail"></i>
                    <i class="fas fa-times-circle imaage-remove" wire:click="phoroRemove({{$item->id}})" title="Remove"></i>                    
