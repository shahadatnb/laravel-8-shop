                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td id="header_wrapper" style="padding: 36px 48px; display: block;">
                                            <h1
                                                style='font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #ab79a1; color: #ffffff; background-color: inherit;'>
                                                ...
                                                <tr>
                                                    <td valign="top" style="padding: 48px 48px 32px;">
                                                        <div id="body_content_inner"
                                                            ...
                                                            <p style="margin: 0 0 16px;">Just to let you know — we've
                                                                received your order #{{ $order->id }}, and it is now
                                                                being processed:</p>
                                                            ...
                                                            <h2
                                                                ...
                                                                [Order #{{ $order->id }}]
                                                                ({{ CustomHelper::prettyDate($order->created_at) }})
                                                            </h2>
                                                                                ...
                                                                                <td class="td"
                                                                                    ...
                                                                                    <span
                                                                                        class="woocommerce-Price-amount amount"><span
                                                                                            class="woocommerce-Price-currencySymbol">{{ config('settings.currencySymbol') }}</span>{{ $item->total }}</span>
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
                                                                    ...
                                                                    <tfoot>
                                                                        <tr>
                                                                            ...
                                                                            <td class="td"
                                                                                ...
                                                                                <span
                                                                                    class="woocommerce-Price-amount amount"><span
                                                                                        class="woocommerce-Price-currencySymbol">{{ config('settings.currencySymbol') }}</span>{{ $order->sub_total }}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th class="td" scope="row"
                                                                            ...
                                                                            <td class="td"
                                                                                ...
                                                                                <span
                                                                                    class="woocommerce-Price-amount amount"><span
                                                                                        class="woocommerce-Price-currencySymbol">{{ config('settings.currencySymbol') }}</span>{{ $order->shipping_amount }}</span>
                                                                                <small class="shipped_via">{{ $order->shipping_method}}</small>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th class="td" scope="row"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="td"
                                                                                ...
                                                                                <span
                                                                                    class="woocommerce-Price-amount amount"><span
                                                                                        class="woocommerce-Price-currencySymbol">{{ config('settings.currencySymbol') }}</span>{{ $order->grand_total }}</span>
                                                                            </td>
                                                                        </tr>
                                                                    </tfoot>
                                                                </table>
                                                            ...
                                                            <table id="addresses" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="top" width="50%"
                                                                        ...
                                                                        <h2
                                                                            style='color: #96588a; display: block; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;'>
                                                                            Billing address and Shipping address</h2>
                                                                        <address class="address"
                                                                            ...
                                                                            <br><a href="tel:01757839516"
                                                                                style="color: #96588a; font-weight: normal; text-decoration: underline;">{{ $order->shippingAddress->phone }}</a>
